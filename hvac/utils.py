...
# def display_deprecation_w arning():


def deprecated_property(to_be_removed_in_version, new_method=None):
    ...
    def decorator(method):
        message = "Call to deprecated property '{old_func}'. This method will be removed in version '{version}'".format(
